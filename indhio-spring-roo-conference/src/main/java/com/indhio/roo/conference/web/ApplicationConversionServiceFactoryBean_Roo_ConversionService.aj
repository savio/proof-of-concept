...
import com.indhio.roo.conference.web.ApplicationConversionServiceFactoryBean;
...
privileged aspect ApplicationConversionServiceFactoryBean_Roo_ConversionService {
    ...
    public Converter<Speaker, String> ApplicationConversionServiceFactoryBean.getSpeakerToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<com.indhio.roo.conference.domain.Speaker, java.lang.String>() {
    ...
    public Converter<Long, Speaker> ApplicationConversionServiceFactoryBean.getIdToSpeakerConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, com.indhio.roo.conference.domain.Speaker>() {
            public com.indhio.roo.conference.domain.Speaker convert(java.lang.Long id) {
    ...
    public Converter<String, Speaker> ApplicationConversionServiceFactoryBean.getStringToSpeakerConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, com.indhio.roo.conference.domain.Speaker>() {
            public com.indhio.roo.conference.domain.Speaker convert(String id) {
    ...
    public Converter<Talk, String> ApplicationConversionServiceFactoryBean.getTalkToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<com.indhio.roo.conference.domain.Talk, java.lang.String>() {
    ...
    public Converter<Long, Talk> ApplicationConversionServiceFactoryBean.getIdToTalkConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, com.indhio.roo.conference.domain.Talk>() {
            public com.indhio.roo.conference.domain.Talk convert(java.lang.Long id) {
    ...
    public Converter<String, Talk> ApplicationConversionServiceFactoryBean.getStringToTalkConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, com.indhio.roo.conference.domain.Talk>() {
            public com.indhio.roo.conference.domain.Talk convert(String id) {
